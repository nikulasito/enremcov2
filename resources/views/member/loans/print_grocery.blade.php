...
<body>
    @php
        ...
        $store = $app->grocery_partner_store ?? '';
    ...
    <div class="center title">GROCERY LOAN</div>
    ...
    <div class="box mt-8">
        <div class="small" style="font-weight:700;">GROCERY ASSISTANCE DETAILS</div>
        <table class="plain mt-4">
            <tr>
                <td style="width:50%;"><b>Preferred Store/Partner:</b> <span class="line">{{ $store }}</span></td>
                <td style="width:50%;"><b>Household Size:</b> <span class="line-sm">{{ $householdSize }}</span></td>
            </tr>
            <tr>
                <td colspan="2">
                    <b>Coverage Period:</b>
                    <span class="line-sm">{{ $periodFrom }}</span>
                    to
                    <span class="line-sm">{{ $periodTo }}</span>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="justify small mt-12">
        I certify that this grocery loan shall be used for basic household food and essential grocery items only. I
        agree to comply with ENREMCO grocery loan usage and documentation requirements.
    </div>
