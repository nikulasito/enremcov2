...
<body>
    @php
        ...
        $cashPrice = (float) ($app->appliance_cash_price ?? 0);
    ...
    <div class="box mt-8">
        ...
        <table class="plain mt-4">
            <tr>
                <td style="width:50%;"><b>Item:</b> <span class="line">{{ $item }}</span></td>
                <td style="width:50%;"><b>Brand/Model:</b> <span class="line">{{ $brandModel }}</span></td>
            </tr>
            <tr>
                <td><b>Supplier/Store:</b> <span class="line">{{ $supplier }}</span></td>
                <td><b>Warranty (months):</b> <span class="line-sm">{{ $warrantyMonths }}</span></td>
            </tr>
            <tr>
                <td><b>Cash Price:</b> <span class="line-sm">P{{ number_format($cashPrice, 2) }}</span></td>
    ...
    <div class="box mt-8">
        <table class="bordered">
            ...
            <tr><td>Interest (3%)</td><td align="right">P{{ number_format($int, 2) }}</td></tr>
    ...
    <div class="mt-20 xsmall center">Appliance Loan Printable Form</div>
</body>
